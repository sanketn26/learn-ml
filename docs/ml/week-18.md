...
Same four-line training step as Week 14. Only the *body* of `forward` changed.
...
When you can explain the week out loud, do the [exercises](exercises/week-18.md). Starter: `python exercises/ml/week-18/starter.py` from the repo root.
