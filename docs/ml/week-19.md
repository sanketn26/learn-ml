...
## Same CloudWave sequences as Week 18, new `forward`
...
When you can explain the week out loud, do the [exercises](exercises/week-19.md). Starter: `python exercises/ml/week-19/starter.py` from the repo root.
