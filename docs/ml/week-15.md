# Week 15 — Capstone: A Training Notebook Is Not Production
...
!!! think "Think of it like… a build artifact + an API contract."
    ...
    The model file is a binary. The scaler is part of that binary. The request body is the feature list from Week 6. If any of those three drift independently, production is a silent wrong-number generator.
